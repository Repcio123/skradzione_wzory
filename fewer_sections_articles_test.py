...
if __name__ == "__main__":
    test = FewerSections()
    with open("files_to_test/fewer_sections/test_results.txt", "w") as f:
        f.write(str(test.compare_articles_by_hashes_test_laplace()) + "\n")
        f.write(str(test.compare_articles_by_hashes_test_main4()) + "\n")
        f.write(str(test.compare_articles_by_chars_test_laplace()) + "\n")
        f.write(str(test.compare_articles_by_chars_test_main4()) + "\n")
        f.write(str(test.compare_articles_lavensthein_laplace()) + "\n")
        f.write(str(test.compare_articles_lavensthein_main4()) + "\n")
        f.write(str(test.compare_articles_cosine_laplace()) + "\n")
        f.write(str(test.compare_articles_cosine_main4()) + "\n")
        f.write(str(test.compare_articles_jaccard_laplace()) + "\n")